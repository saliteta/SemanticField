...
from semanticField.data.SemanticFieldDataParser import SemanticDataparserOutput
...
class SemanticFieldDataset(InputDataset):
    def __init__(self, dataparser_outputs: SemanticDataparserOutput, scale_factor: float = 1):
